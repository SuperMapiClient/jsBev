...
if (!String.prototype.startsWith) {
    ...
    String.prototype.startsWith = function(sStart) {
        return SuperMap.String.startsWith(this, sStart);
    };
}
...
if (!String.prototype.contains) {
    ...
    String.prototype.contains = function(str) {
        return SuperMap.String.contains(this, str);
    };
}
...
if (!String.prototype.trim) {
    ...
    String.prototype.trim = function() {
        return SuperMap.String.trim(this);
    };
}
...
if (!String.prototype.camelize) {
    ...
    String.prototype.camelize = function() {
        return SuperMap.String.camelize(this);
    };
}
...
if (!Function.prototype.bind) {
     ...
     * 
     * Parameters:
     * object - {Object} this 参数
     * 
     * Returns:
     * {Function} "this"对象修改后匿名函数.
     */
    Function.prototype.bind = function() {
        // new function takes the same arguments with this function up front
        Array.prototype.unshift.apply(arguments, [this]);
        return SuperMap.Function.bind.apply(null, arguments);
    };
}
...
if (!Function.prototype.bindAsEventListener) {
     ...
     * 
     * Parameters:
     * object - {Object} this 引用.
     * 
     * Returns:
     * {Function}
     */
    Function.prototype.bindAsEventListener = function(object) {
        return SuperMap.Function.bindAsEventListener(this, object);
    };
}
