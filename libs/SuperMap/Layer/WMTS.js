...
SuperMap.Layer.WMTS = SuperMap.Class(SuperMap.Layer.Grid, {
    ...
    /**
     * APIProperty: url
     * {String} WMTS服务的url，必设属性。
     */
    url: null,

    /**
     * APIProperty: layer
     * {String} WMTS服务发布的图层标识符，必设属性。
     */
    layer: null,
    ...
    /** 
     * APIProperty: format
     * {String} 图像的MIME类型。默认为 "image/png"。
     */
    format: "image/png",
     ...
     * url - {String} WMTS服务的url。
     * layer - {String} 图层标识符。  
     * style - {String} 图层样式标识符。 
     * matrixSet - {String} 瓦片矩阵集标识符。
     */
     ...
     * 
     * Returns:
     * {<SuperMap.Layer.WMTS>} 克隆 <SuperMap.Layer.WMTS>
     */
    clone: function(obj) {
        if (obj == null) {
