...
SuperMap.REST.FindLocationParameters = SuperMap.Class({
     ...
     * {Integer} 期望用于最终设施选址的资源供给中心数量，必设字段。
     ...
     * {String} 转向权值字段的名称。
     * 可以通过 GetTurnNodeWeightNamesService 类获取服务端发布的所有转向权重字段。 
     */ 
     ...
     * 可以通过 GetEdgeWeightNamesService 类获取服务端发布的所有耗费字段。 
     */ 
    weightName: null,
     ...
     * nodeDemandField - {String} 结点需求量字段，必设字段。
