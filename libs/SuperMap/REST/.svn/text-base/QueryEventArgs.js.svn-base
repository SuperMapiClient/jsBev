...
/**
 * Class: SuperMap.REST.QueryEventArgs
 * 查询服务事件数据类。
 * 该类包含了从服务端传回的查询结果数据。
 *
 * Inherits from:
...
SuperMap.REST.QueryEventArgs = SuperMap.Class(SuperMap.ServiceEventArgs, {
    ...
    /** 
     * APIProperty: result
     * {<SuperMap.REST.QueryResult>} 服务端返回的查询结果数据，其中包含了查询记录集或查询结果资源的相关信息。
     */
    result: null,
    
    /**
     * Constructor: SuperMap.REST.QueryEventArgs
     * 查询服务事件数据类构造函数。
     *
     * Parameters:
     * result - {<SuperMap.REST.QueryResult>} 服务端返回的查询结果数据。
