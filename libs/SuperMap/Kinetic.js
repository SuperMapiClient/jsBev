...
SuperMap.Kinetic = SuperMap.Class({
     ...
     * {Float} the deseleration in px/ms虏, default to 0.0035.
     */
    //改变了他的默认值看起来更加平滑。
    deceleration: 0.0155,
     ...
     *
     * Parameters:
     * xy - {<SuperMap.Pixel>} The new position.
     */
    update: function(xy) {
     ...
     *
     * Parameters:
     * xy - {<SuperMap.Pixel>} The last position.
     *
     * Returns:
    ...
    move: function(info, callback) {
        ...
        this.timerId = window.setInterval(
            SuperMap.Function.bind(timerCallback, this),
            this.interval);
    },
