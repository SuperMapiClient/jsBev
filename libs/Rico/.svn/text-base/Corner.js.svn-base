 ...
 * version by the SuperMap development team.
 *  
...
SuperMap.Rico.Corner = {

    round: function(e, options) {
        e = SuperMap.Util.getElement(e);
   ...
   _blend: function(c1, c2) { var cc1 = SuperMap.Rico.Color.createFromHex(c1); cc1.blend(SuperMap.Rico.Color.createFromHex(c2)); return cc1; },
   _background: function(el) { try { return SuperMap.Rico.Color.createColorFromBackground(el).asHex(); } catch(err) { return "#ffffff"; } },
